...
const starIcon = (
  <svg
    ...
    viewBox="0 0 576 512"
    className="h-5 w-5 text-primary shrink-0 mt-[2px]"
  >
      ...
      <div className="container px-4 mx-auto">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative aspect-[25/24] max-w-[500px] w-full mx-auto lg:mx-0">
              <Image
                src="/images/about/about-image-2.svg"
                alt="about image"
                fill
                className="drop-shadow-three dark:hidden object-contain"
              />
              <Image
                src="/images/about/about-image-2-dark.svg"
                alt="about image"
                fill
                className="drop-shadow-three hidden dark:block object-contain"
              />
            </div>
          </div>
          {/* Text Content */}
